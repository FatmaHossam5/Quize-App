    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-2 md:grid-cols-3 mt-3">
        <Link to="/" className="signin">
          <div className="content text-8xl py-3 bg-stone-700rounded-lg text-center bg-stone-700 border-4 border-secondry">
            <i className="fa-solid fa-user text-secondry"></i>
            <p className="text-base mt-2">Sign in</p>
          </div>
        </Link>
        <Link to="/rigester" className="signup">
          <div className="content text-8xl py-3 bg-stone-700 rounded-lg text-center border-4 border-stone-700">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="my-12">
        <div className="email mt-2">
          ...
          <div             className={`flex rounded-md border-3 ${
        ...
        <AuthButton text={String("Sign In")}/>


          <p>
            Forgot password?{" "}
            <Link className="text-secondry" to="/requsetRestPass">
              click here
            </Link>
          </p>
        </div>
